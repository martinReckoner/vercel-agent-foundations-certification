...
export const shoppingAgent = new ToolLoopAgent({ 
    ...
    When the user want to know more about a product, use the getProduct tool, infer the ID by context. if the user want to know more about an specific product name, use the id of the product to call the getProduct tool.
    `, 
